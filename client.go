...
// FgaApiInternalError will be returned if there are internal errors in Auth0 Fine Grained Authorization (FGA)
...
// FgaApiRateLimitExceededError will be returned if error happens becuase API's calling rate exceed limit
...
// ResponseCode returns response code
func (e FgaApiRateLimitExceededError) ResponseCode() ResourceExhaustedErrorCode {
	return e.responseCode
}
