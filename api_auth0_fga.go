...
type Auth0FgaApi interface {
	...
	## Limits
	- Each store has a limit of **50** check requests per second (RPS).
	## Example
	...
	*/
	 ...
	 * @return Auth0FgaCheckResponse
	 */
	CheckExecute(r ApiCheckRequest) (Auth0FgaCheckResponse, *_nethttp.Response, error)

	/*
		 * DeleteTokenIssuer Remove 3rd party token issuer for Auth0 FGA read and write operation
		 * The DELETE token-issuers API will remove the 3rd party token issuer as a token issuer that are allowed by Auth0 FGA.  The specified id is the id associated with the issuer url that is to be removed.
	...
	*/
	 ...
	 * @return Auth0FgaExpandResponse
	 */
	ExpandExecute(r ApiExpandRequest) (Auth0FgaExpandResponse, *_nethttp.Response, error)
	...
	## Limits
	- Each store has a limit of **2** read requests per second (RPS).
	## Examples
	...
	*/
	 ...
	 * @return Auth0FgaReadResponse
	 */
	ReadExecute(r ApiReadRequest) (Auth0FgaReadResponse, *_nethttp.Response, error)
	 ...
	 * @return Auth0FgaReadAssertionsResponse
	 */
	ReadAssertionsExecute(r ApiReadAssertionsRequest) (Auth0FgaReadAssertionsResponse, *_nethttp.Response, error)
	...
	In the above example, there is only 1 type (`document`) with 2 relations (`writer` and `reader`).
		 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		 * @param id The authorization model ID
	...
	*/
	 ...
	 * @return Auth0FgaReadAuthorizationModelResponse
	 */
	ReadAuthorizationModelExecute(r ApiReadAuthorizationModelRequest) (Auth0FgaReadAuthorizationModelResponse, *_nethttp.Response, error)
	...
	*/
	 ...
	 * @return Auth0FgaReadAuthorizationModelsResponse
	 */
	ReadAuthorizationModelsExecute(r ApiReadAuthorizationModelsRequest) (Auth0FgaReadAuthorizationModelsResponse, *_nethttp.Response, error)
	...
	*/
	 ...
	 */
	ReadSettingsExecute(r ApiReadSettingsRequest) (SettingsSettings, *_nethttp.Response, error)
	...
	*/
	...
	- Each store can have at most **10** authorization models.
	...
	*/
	 ...
	 * @return Auth0FgaWriteAuthorizationModelResponse
	 */
	WriteAuthorizationModelExecute(r ApiWriteAuthorizationModelRequest) (Auth0FgaWriteAuthorizationModelResponse, *_nethttp.Response, error)
	...
	*/
	 ...
	 * @return SettingsSettings
	 */
	WriteSettingsExecute(r ApiWriteSettingsRequest) (SettingsSettings, *_nethttp.Response, error)
	...
	1. In the 3rd party issuer, configure Auth0 FGA API with the following audience (`https://api.staging.fga.dev`) in its issuer configuration.
	...
	*/
	 ...
	 * @return SettingsTokenIssuer
	 */
	WriteTokenIssuerExecute(r ApiWriteTokenIssuerRequest) (SettingsTokenIssuer, *_nethttp.Response, error)
}
...
func (r ApiCheckRequest) Body(body Auth0FgaCheckRequestParams) ApiCheckRequest {
	r.body = &body
	return r
}

func (r ApiCheckRequest) Execute() (Auth0FgaCheckResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaCheckResponse
 */
func (a *Auth0FgaApiService) CheckExecute(r ApiCheckRequest) (Auth0FgaCheckResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  Auth0FgaCheckResponse
	)
...
func (r ApiExpandRequest) Body(body Auth0FgaExpandRequestParams) ApiExpandRequest {
	r.body = &body
	return r
}

func (r ApiExpandRequest) Execute() (Auth0FgaExpandResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaExpandResponse
 */
func (a *Auth0FgaApiService) ExpandExecute(r ApiExpandRequest) (Auth0FgaExpandResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Auth0FgaExpandResponse
	)
...
func (r ApiReadRequest) Body(body Auth0FgaReadRequestParams) ApiReadRequest {
	r.body = &body
	return r
}

func (r ApiReadRequest) Execute() (Auth0FgaReadResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaReadResponse
 */
func (a *Auth0FgaApiService) ReadExecute(r ApiReadRequest) (Auth0FgaReadResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Auth0FgaReadResponse
	)
...
func (r ApiReadAssertionsRequest) Execute() (Auth0FgaReadAssertionsResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaReadAssertionsResponse
 */
func (a *Auth0FgaApiService) ReadAssertionsExecute(r ApiReadAssertionsRequest) (Auth0FgaReadAssertionsResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Auth0FgaReadAssertionsResponse
	)
...
func (r ApiReadAuthorizationModelRequest) Execute() (Auth0FgaReadAuthorizationModelResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaReadAuthorizationModelResponse
 */
func (a *Auth0FgaApiService) ReadAuthorizationModelExecute(r ApiReadAuthorizationModelRequest) (Auth0FgaReadAuthorizationModelResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Auth0FgaReadAuthorizationModelResponse
	)
...
func (r ApiReadAuthorizationModelsRequest) Execute() (Auth0FgaReadAuthorizationModelsResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaReadAuthorizationModelsResponse
 */
func (a *Auth0FgaApiService) ReadAuthorizationModelsExecute(r ApiReadAuthorizationModelsRequest) (Auth0FgaReadAuthorizationModelsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Auth0FgaReadAuthorizationModelsResponse
	)
...
func (r ApiReadSettingsRequest) Execute() (SettingsSettings, *_nethttp.Response, error) {
 ...
 * @return SettingsSettings
 */
func (a *Auth0FgaApiService) ReadSettingsExecute(r ApiReadSettingsRequest) (SettingsSettings, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiWriteRequest) Body(body Auth0FgaWriteRequestParams) ApiWriteRequest {
	r.body = &body
	return r
}
...
type ApiWriteAssertionsRequest struct {
	...
	authorizationModelId string
	body                 *Auth0FgaWriteAssertionsRequestParams
}

func (r ApiWriteAssertionsRequest) Body(body Auth0FgaWriteAssertionsRequestParams) ApiWriteAssertionsRequest {
	r.body = &body
	return r
}
...
func (r ApiWriteAuthorizationModelRequest) Body(body AuthorizationmodelTypeDefinitions) ApiWriteAuthorizationModelRequest {
	r.body = &body
	return r
}

func (r ApiWriteAuthorizationModelRequest) Execute() (Auth0FgaWriteAuthorizationModelResponse, *_nethttp.Response, error) {
 ...
 * @return Auth0FgaWriteAuthorizationModelResponse
 */
func (a *Auth0FgaApiService) WriteAuthorizationModelExecute(r ApiWriteAuthorizationModelRequest) (Auth0FgaWriteAuthorizationModelResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Auth0FgaWriteAuthorizationModelResponse
	)
...
func (r ApiWriteSettingsRequest) Body(body Auth0FgaWriteSettingsRequestParams) ApiWriteSettingsRequest {
	r.body = &body
	return r
}

func (r ApiWriteSettingsRequest) Execute() (SettingsSettings, *_nethttp.Response, error) {
 ...
 * @return SettingsSettings
 */
func (a *Auth0FgaApiService) WriteSettingsExecute(r ApiWriteSettingsRequest) (SettingsSettings, *_nethttp.Response, error) {
	var (
...
func (r ApiWriteTokenIssuerRequest) Body(body Auth0FgaWriteTokenIssuersRequestParams) ApiWriteTokenIssuerRequest {
	r.body = &body
	return r
}

func (r ApiWriteTokenIssuerRequest) Execute() (SettingsTokenIssuer, *_nethttp.Response, error) {
 ...
 * @return SettingsTokenIssuer
 */
func (a *Auth0FgaApiService) WriteTokenIssuerExecute(r ApiWriteTokenIssuerRequest) (SettingsTokenIssuer, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  SettingsTokenIssuer
	)
